...
- Growth stock valuation
    ...
    where ![image](https://latex.codecogs.com/png.latex?PE_{estimate}) is from the function of growth rate,  ![image](https://latex.codecogs.com/png.latex?PE_{estimate}=f(g))
